	...
	return (
		<View className="flex-1 bg-background">
			...
			<ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
				...
				>
					<Text className="text-base text-primary">ADD TAGS</Text>
				...
				<TouchableOpacity
					...
					className="border-b border-border px-4 py-4 flex-row items-center justify-between"
				>
					<Text className="text-base text-primary">ADD LOCATION</Text>
					<ChevronRight size={20} color="#999" />
				</TouchableOpacity>
				...
				<View className="px-4 py-6">
					<Text className="text-sm text-muted-foreground italic">
						caption drafting^ <Text className="not-italic">paper clip</Text> logo to tag listings
					</Text>
				</View>
			</ScrollView>
			...
			<View className="border-t border-border p-4">
				<TouchableOpacity onPress={handlePost} className="bg-primary py-3 rounded-lg items-center">
